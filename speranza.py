...
system_prompt_path = os.path.join(os.path.dirname(__file__), "prompt_ministro.txt")
...
def estrai_parametri_da_proposta(proposta_presidente):
    ...
    system_prompt_parametri = (
        ...
        "virus-check-frequency (numero intero di tick (giorni), frequenza controlli/tamponi, abbassalo se ritieni che i controlli vengano intensificati, default 7, max 7), "
...
def genera_risposta(total_dead, proposta_presidente, accordo_speranza):
    ...
    chat._config.system_instruction = system_prompt
